...
def integrate_flux_stencil(
    ...
    with computation(PARALLEL), interval(...):
        fx[0,0,0][0] = fx[0,0,0][0] * w[0,0,0][0]
        fx[0,0,0][1] = fx[0,0,0][1] * w[0,0,0][1]
        fx[0,0,0][2] = fx[0,0,0][2] * w[0,0,0][2]
        fx[0,0,0][3] = fx[0,0,0][3] * w[0,0,0][3]

        x_0, x_1, x_2, x_3 = matmul_4_4_T(phi_grad_x, fx)

        fy[0,0,0][0] = fy[0,0,0][0] * w[0,0,0][0]
        fy[0,0,0][1] = fy[0,0,0][1] * w[0,0,0][1]
        fy[0,0,0][2] = fy[0,0,0][2] * w[0,0,0][2]
        fy[0,0,0][3] = fy[0,0,0][3] * w[0,0,0][3]

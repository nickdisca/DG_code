...
def first_stencil(
    ...
    h_modal: gtscript.Field[(dtype, (dim,))],
    ...
    hu_modal: gtscript.Field[(dtype, (dim,))],
    ...
    hv_modal: gtscript.Field[(dtype, (dim,))]
    ...
    with computation(PARALLEL), interval(...):
        h_n = phi_bd_N @ h_modal
        h_s = phi_bd_S @ h_modal
        h_e = phi_bd_E @ h_modal
        h_w = phi_bd_W @ h_modal

        hu_n = phi_bd_N @ hu_modal
        hu_s = phi_bd_S @ hu_modal
        hu_e = phi_bd_E @ hu_modal
        hu_w = phi_bd_W @ hu_modal

        hv_n = phi_bd_N @ hv_modal
        hv_s = phi_bd_S @ hv_modal
        hv_e = phi_bd_E @ hv_modal
        hv_w = phi_bd_W @ hv_modal
...
@gtscript.stencil(backend=backend, **backend_opts)
def fused_source_coriolis_stencil(
    phi: gtscript.Field[(dtype, (n_qp, dim))],
    inv_mass: gtscript.Field[(dtype, (dim, dim))],

...
def run(*, vander_inv, in_modal, out_nodal, _domain_, _origin_):
    ...
    vander_inv = Field(vander_inv, _origin_["vander_inv"], (True, True, True))
    in_modal = Field(in_modal, _origin_["in_modal"], (True, True, True))
    out_nodal = Field(out_nodal, _origin_["out_nodal"], (True, True, True))
    ...
    with np.errstate(divide="ignore", over="ignore", under="ignore", invalid="ignore"):
        ...
        a_0__9a1_7_29_gen_0 = (
            (
                (vander_inv[i:I, j:J, k:K, 0, 0] * in_modal[i:I, j:J, k:K, 0])
                + (vander_inv[i:I, j:J, k:K, 0, 1] * in_modal[i:I, j:J, k:K, 1])
            )
            + (vander_inv[i:I, j:J, k:K, 0, 2] * in_modal[i:I, j:J, k:K, 2])
        ) + (vander_inv[i:I, j:J, k:K, 0, 3] * in_modal[i:I, j:J, k:K, 3])
        a_1__9a1_7_29_gen_0 = (
            (
                (vander_inv[i:I, j:J, k:K, 1, 0] * in_modal[i:I, j:J, k:K, 0])
                + (vander_inv[i:I, j:J, k:K, 1, 1] * in_modal[i:I, j:J, k:K, 1])
            )
            + (vander_inv[i:I, j:J, k:K, 1, 2] * in_modal[i:I, j:J, k:K, 2])
        ) + (vander_inv[i:I, j:J, k:K, 1, 3] * in_modal[i:I, j:J, k:K, 3])
        a_2__9a1_7_29_gen_0 = (
            (
                (vander_inv[i:I, j:J, k:K, 2, 0] * in_modal[i:I, j:J, k:K, 0])
                + (vander_inv[i:I, j:J, k:K, 2, 1] * in_modal[i:I, j:J, k:K, 1])
            )
            + (vander_inv[i:I, j:J, k:K, 2, 2] * in_modal[i:I, j:J, k:K, 2])
        ) + (vander_inv[i:I, j:J, k:K, 2, 3] * in_modal[i:I, j:J, k:K, 3])
        a_3__9a1_7_29_gen_0 = (
            (
                (vander_inv[i:I, j:J, k:K, 3, 0] * in_modal[i:I, j:J, k:K, 0])
                + (vander_inv[i:I, j:J, k:K, 3, 1] * in_modal[i:I, j:J, k:K, 1])
            )
            + (vander_inv[i:I, j:J, k:K, 3, 2] * in_modal[i:I, j:J, k:K, 2])
        ) + (vander_inv[i:I, j:J, k:K, 3, 3] * in_modal[i:I, j:J, k:K, 3])
        a_0_gen_0 = a_0__9a1_7_29_gen_0
        a_1_gen_0 = a_1__9a1_7_29_gen_0
        a_2_gen_0 = a_2__9a1_7_29_gen_0
        a_3_gen_0 = a_3__9a1_7_29_gen_0
        out_nodal[i:I, j:J, k:K, 0] = a_0_gen_0
        out_nodal[i:I, j:J, k:K, 1] = a_1_gen_0
        out_nodal[i:I, j:J, k:K, 2] = a_2_gen_0
        out_nodal[i:I, j:J, k:K, 3] = a_3_gen_0

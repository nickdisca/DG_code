...
def run(*, phi_bd, in_nodal, out, _domain_, _origin_):
    ...
    phi_bd = Field(phi_bd, _origin_["phi_bd"], (True, True, True))
    in_nodal = Field(in_nodal, _origin_["in_nodal"], (True, True, True))
    out = Field(out, _origin_["out"], (True, True, True))
    ...
    with np.errstate(divide="ignore", over="ignore", under="ignore", invalid="ignore"):
        ...
        a_0__9d0_7_20_gen_0 = (
            (
                (phi_bd[i:I, j:J, k:K, 0, 0] * in_nodal[i:I, j:J, k:K, 0])
                + (phi_bd[i:I, j:J, k:K, 0, 1] * in_nodal[i:I, j:J, k:K, 1])
            )
            + (phi_bd[i:I, j:J, k:K, 0, 2] * in_nodal[i:I, j:J, k:K, 2])
        ) + (phi_bd[i:I, j:J, k:K, 0, 3] * in_nodal[i:I, j:J, k:K, 3])
        a_1__9d0_7_20_gen_0 = (
            (
                (phi_bd[i:I, j:J, k:K, 1, 0] * in_nodal[i:I, j:J, k:K, 0])
                + (phi_bd[i:I, j:J, k:K, 1, 1] * in_nodal[i:I, j:J, k:K, 1])
            )
            + (phi_bd[i:I, j:J, k:K, 1, 2] * in_nodal[i:I, j:J, k:K, 2])
        ) + (phi_bd[i:I, j:J, k:K, 1, 3] * in_nodal[i:I, j:J, k:K, 3])
        a_0_gen_0 = a_0__9d0_7_20_gen_0
        a_1_gen_0 = a_1__9d0_7_20_gen_0
        out[i:I, j:J, k:K, 0] = a_0_gen_0
        out[i:I, j:J, k:K, 1] = a_1_gen_0

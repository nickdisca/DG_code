...
import m_computation__gtcnumpy_c86012c67e as computation
...
class modal2bd____gtcnumpy_c86012c67e(StencilObject):
    """
    ...
    def __call__(self, phi_bd, in_nodal, out, domain=None, origin=None, validate_args=True, exec_info=None):
        if exec_info is not None:
            exec_info["call_start_time"] = time.perf_counter()

        field_args = dict(out=out, in_nodal=in_nodal, phi_bd=phi_bd)
        parameter_args = dict()
        ...
        if exec_info is not None:
            ...
            if exec_info.setdefault("__aggregate_data", False):
                stencil_info = exec_info.setdefault("modal2bd____gtcnumpy_c86012c67e", {})
    ...
    def run(
        ...
        *,
        ...
        computation.run(phi_bd=phi_bd, in_nodal=in_nodal, out=out, _domain_=_domain_, _origin_=_origin_)
        if exec_info is not None:

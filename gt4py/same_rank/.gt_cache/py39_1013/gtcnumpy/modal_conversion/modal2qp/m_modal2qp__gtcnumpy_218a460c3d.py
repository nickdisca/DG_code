...
import m_computation__gtcnumpy_218a460c3d as computation
...
class modal2qp____gtcnumpy_218a460c3d(StencilObject):
    """
    ...
    def __call__(self, phi, in_nodal, out_modal, domain=None, origin=None, validate_args=True, exec_info=None):
        if exec_info is not None:
            exec_info["call_start_time"] = time.perf_counter()

        field_args = dict(out_modal=out_modal, in_nodal=in_nodal, phi=phi)
        parameter_args = dict()
        ...
        if exec_info is not None:
            ...
            if exec_info.setdefault("__aggregate_data", False):
                stencil_info = exec_info.setdefault("modal2qp____gtcnumpy_218a460c3d", {})
    ...
    def run(
        ...
        *,
        ...
        computation.run(phi=phi, in_nodal=in_nodal, out_modal=out_modal, _domain_=_domain_, _origin_=_origin_)
        if exec_info is not None:

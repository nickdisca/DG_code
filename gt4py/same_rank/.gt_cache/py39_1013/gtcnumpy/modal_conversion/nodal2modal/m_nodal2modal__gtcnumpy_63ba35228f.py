...
import m_computation__gtcnumpy_63ba35228f as computation
...
class nodal2modal____gtcnumpy_63ba35228f(StencilObject):
    """
    ...
    def __call__(self, vander, in_nodal, out_modal, domain=None, origin=None, validate_args=True, exec_info=None):
        if exec_info is not None:
            exec_info["call_start_time"] = time.perf_counter()

        field_args = dict(out_modal=out_modal, in_nodal=in_nodal, vander=vander)
        parameter_args = dict()
        ...
        if exec_info is not None:
            ...
            if exec_info.setdefault("__aggregate_data", False):
                stencil_info = exec_info.setdefault("nodal2modal____gtcnumpy_63ba35228f", {})
    ...
    def run(
        ...
        *,
        ...
        computation.run(vander=vander, in_nodal=in_nodal, out_modal=out_modal, _domain_=_domain_, _origin_=_origin_)
        if exec_info is not None:

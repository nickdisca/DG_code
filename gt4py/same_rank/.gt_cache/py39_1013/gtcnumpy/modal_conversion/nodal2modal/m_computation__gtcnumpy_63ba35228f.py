...
def run(*, vander, in_nodal, out_modal, _domain_, _origin_):
    ...
    vander = Field(vander, _origin_["vander"], (True, True, True))
    ...
    with np.errstate(divide="ignore", over="ignore", under="ignore", invalid="ignore"):
        ...
        a_0__9a1_7_29_gen_0 = (
            (
                (vander[i:I, j:J, k:K, 0, 0] * in_nodal[i:I, j:J, k:K, 0])
                + (vander[i:I, j:J, k:K, 0, 1] * in_nodal[i:I, j:J, k:K, 1])
            )
            + (vander[i:I, j:J, k:K, 0, 2] * in_nodal[i:I, j:J, k:K, 2])
        ) + (vander[i:I, j:J, k:K, 0, 3] * in_nodal[i:I, j:J, k:K, 3])
        a_1__9a1_7_29_gen_0 = (
            (
                (vander[i:I, j:J, k:K, 1, 0] * in_nodal[i:I, j:J, k:K, 0])
                + (vander[i:I, j:J, k:K, 1, 1] * in_nodal[i:I, j:J, k:K, 1])
            )
            + (vander[i:I, j:J, k:K, 1, 2] * in_nodal[i:I, j:J, k:K, 2])
        ) + (vander[i:I, j:J, k:K, 1, 3] * in_nodal[i:I, j:J, k:K, 3])
        a_2__9a1_7_29_gen_0 = (
            (
                (vander[i:I, j:J, k:K, 2, 0] * in_nodal[i:I, j:J, k:K, 0])
                + (vander[i:I, j:J, k:K, 2, 1] * in_nodal[i:I, j:J, k:K, 1])
            )
            + (vander[i:I, j:J, k:K, 2, 2] * in_nodal[i:I, j:J, k:K, 2])
        ) + (vander[i:I, j:J, k:K, 2, 3] * in_nodal[i:I, j:J, k:K, 3])
        a_3__9a1_7_29_gen_0 = (
            (
                (vander[i:I, j:J, k:K, 3, 0] * in_nodal[i:I, j:J, k:K, 0])
                + (vander[i:I, j:J, k:K, 3, 1] * in_nodal[i:I, j:J, k:K, 1])
            )
            + (vander[i:I, j:J, k:K, 3, 2] * in_nodal[i:I, j:J, k:K, 2])
        ) + (vander[i:I, j:J, k:K, 3, 3] * in_nodal[i:I, j:J, k:K, 3])

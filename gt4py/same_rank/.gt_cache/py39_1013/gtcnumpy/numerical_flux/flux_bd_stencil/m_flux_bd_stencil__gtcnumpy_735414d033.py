...
import m_computation__gtcnumpy_735414d033 as computation
...
class flux_bd_stencil____gtcnumpy_735414d033(StencilObject):
    """
    ...
    def __call__(self, u, fx, fy, domain=None, origin=None, validate_args=True, exec_info=None):
        ...
        if exec_info is not None:
            ...
            if exec_info.setdefault("__aggregate_data", False):
                stencil_info = exec_info.setdefault("flux_bd_stencil____gtcnumpy_735414d033", {})

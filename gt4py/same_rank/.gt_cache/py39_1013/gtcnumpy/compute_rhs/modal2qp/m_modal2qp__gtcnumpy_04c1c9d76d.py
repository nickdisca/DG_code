...
import m_computation__gtcnumpy_04c1c9d76d as computation
...
class modal2qp____gtcnumpy_04c1c9d76d(StencilObject):
    """
    ...
    def __call__(self, phi, in_nodal, out_modal, domain=None, origin=None, validate_args=True, exec_info=None):
        ...
        field_args = dict(in_nodal=in_nodal, phi=phi, out_modal=out_modal)
        parameter_args = dict()
        ...
        if exec_info is not None:
            ...
            if exec_info.setdefault("__aggregate_data", False):
                stencil_info = exec_info.setdefault("modal2qp____gtcnumpy_04c1c9d76d", {})

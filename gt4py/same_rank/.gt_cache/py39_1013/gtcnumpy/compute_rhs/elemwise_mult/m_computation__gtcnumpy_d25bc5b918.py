...
def run(*, a, b, out, _domain_, _origin_):
    ...
    a = Field(a, _origin_["a"], (True, True, True))
    b = Field(b, _origin_["b"], (True, True, True))
    ...
    with np.errstate(divide="ignore", over="ignore", under="ignore", invalid="ignore"):
        ...
        out[i:I, j:J, k:K, 0] = a[i:I, j:J, k:K, 0] * b[i:I, j:J, k:K, 0]
        out[i:I, j:J, k:K, 1] = a[i:I, j:J, k:K, 1] * b[i:I, j:J, k:K, 1]
        out[i:I, j:J, k:K, 2] = a[i:I, j:J, k:K, 2] * b[i:I, j:J, k:K, 2]
        out[i:I, j:J, k:K, 3] = a[i:I, j:J, k:K, 3] * b[i:I, j:J, k:K, 3]

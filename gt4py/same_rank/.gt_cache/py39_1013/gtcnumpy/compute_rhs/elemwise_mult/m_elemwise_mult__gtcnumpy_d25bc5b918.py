...
import m_computation__gtcnumpy_d25bc5b918 as computation
...
class elemwise_mult____gtcnumpy_d25bc5b918(StencilObject):
    """
    ...
    def __call__(self, a, b, out, domain=None, origin=None, validate_args=True, exec_info=None):
        if exec_info is not None:
            exec_info["call_start_time"] = time.perf_counter()

        field_args = dict(a=a, b=b, out=out)
        parameter_args = dict()
        ...
        if exec_info is not None:
            ...
            if exec_info.setdefault("__aggregate_data", False):
                stencil_info = exec_info.setdefault("elemwise_mult____gtcnumpy_d25bc5b918", {})
    ...
    def run(
        ...
        *,
        ...
        computation.run(a=a, b=b, out=out, _domain_=_domain_, _origin_=_origin_)
        if exec_info is not None:
